...
class Functions{
    number1Element: HTMLInputElement; //stores property
    number1: number; //stores value
    number2Element: HTMLInputElement; //stores property
    number2: number; //stores value
    resultOutput: HTMLOutputElement;
    errorMessage: HTMLDivElement;

    constructor(){
        this.number1Element = document.getElementById("num1") as HTMLInputElement;
        this.number1 = 0;  // Initialize to a default value; is here so it can be accessable everywhere
        this.number2Element = document.getElementById("num2") as HTMLInputElement;
        this.number2 = 0;  // Initialize to a default value
        this.resultOutput = document.getElementById("result") as HTMLOutputElement;
